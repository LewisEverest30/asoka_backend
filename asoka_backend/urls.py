...
urlpatterns = [
    ...
    path('get_bracelet_types', get_bracelet_types.as_view()),
    path('get_bracelet_by_type', get_bracelet_by_type.as_view()),
    path('get_certain_bracelet_by_id', get_certain_bracelet_by_id.as_view()),
    # path('get_all_bracelet', get_all_bracelet.as_view()),
    # path('get_certain_bracelet', get_certain_bracelet.as_view()),
    path('get_stamp_types', get_stamp_types.as_view()),
    path('get_stamp_by_type', get_stamp_by_type.as_view()),
    path('get_certain_stamp_by_id', get_certain_stamp_by_id.as_view()),
    # path('get_all_stamp', get_all_stamp.as_view()),
    # path('get_certain_stamp', get_certain_stamp.as_view()),
    path('get_gift_types', get_gift_types.as_view()),
    path('get_gift_by_type', get_gift_by_type.as_view()),
    path('get_certain_gift_by_id', get_certain_gift_by_id.as_view()),
    ...
    path('get_order_by_type', get_order_by_type.as_view()),
    path('get_certain_order_by_id', get_certain_order_by_id.as_view()),
